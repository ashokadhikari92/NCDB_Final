        ...
        <div class="tab-content responsive">
            ...
            <div class="tab-pane active" id="child_details">
                ...
                <div class="form-group col-lg-6">
                    ...
                    {!! Form::text('brth_first_name','Santosh',array('class'=>'form-control')) !!}
                </div>
                <div class="form-group col-lg-6">
                    {!! Form::label('brth_last_name','Last Name') !!}
                    {!! Form::text('brth_last_name','Dhungana',array('class'=>'form-control')) !!}
                </div>
                <div class="form-group col-lg-12">
                    {!! Form::label('brth_full_name','Full Name') !!}
                    <font face="Nepali">{!! Form::text('brth_full_name','Saantosh Dhungana',array('class'=>'form-control','placeholder'=>'नेपालीमा')) !!}</font>
                </div>
                <div class="form-group col-lg-6">
                    {!! Form::label('brth_birth_dat_bs','Date of Birth (B.S.)') !!}
                    {!! Form::text('brth_birth_date_bs','2070-03-02',array('class'=>'form-control nepali-calendar','id'=>'date_bs')) !!}
                </div>
                <div class="form-group col-lg-6">
                    {!! Form::label('brth_birth_date_ad','Date of Birth(A.D.)') !!}
                    {!! Form::text('brth_birth_date_ad','2013-06-16',array('class'=>'form-control datepicker','id'=>'date_ad')) !!}
                </div>
                <div class="form-group col-lg-6">
            ...
            <div class="tab-pane" id="father">
                ...
                <div class="form-group col-lg-6">
                    ...
                    {!! Form::text('father_first_name','Resham Raj',array('class'=>'form-control')) !!}
                </div>
                <div class="form-group col-lg-6">
                    {!! Form::label('father_last_name','Last Name') !!}
                    {!! Form::text('father_last_name','Dhungana',array('class'=>'form-control')) !!}
                </div>
                <div class="form-group col-lg-12">
                    {!! Form::label('father_full_name','Full Name') !!}
                    <font face="Nepali">{!! Form::text('father_full_name','Resham Raj Dhungana',array('class'=>'form-control','placeholder'=>'नेपालीमा')) !!}</font>
                </div>
                <hr>
                <div class="col-lg-12">
                    <h3>Address</h3>
                ...
                <div class="form-group col-lg-6">
                    ...
                    {!! Form::text('father_citizenship_no','2143/3456',array('class'=>'form-control')) !!}
                </div>
                <div class="form-group col-lg-6">
            ...
            <div class="tab-pane" id="mother">
                ...
                <div class="form-group col-lg-6">
                    ...
                    {!! Form::text('mother_first_name','Saraswoti',array('class'=>'form-control')) !!}
                </div>
                <div class="form-group col-lg-6">
                    {!! Form::label('mother_last_name','Last Name') !!}
                    {!! Form::text('mother_last_name','Dhungana',array('class'=>'form-control')) !!}
                </div>
                <div class="form-group col-lg-12">
                    {!! Form::label('mother_full_name','Full Name') !!}
                    <font face="Nepali">{!! Form::text('mother_full_name','Saraswoti Dhungana',array('class'=>'form-control','placeholder'=>'नेपालीमा')) !!}</font>
                </div>
                <hr>
                <div class="col-lg-12">
                    <h3>Address</h3>
                ...
                <div class="form-group col-lg-6">
                    ...
                    {!! Form::text('mother_citizenship_no','1232/4322',array('class'=>'form-control')) !!}
                </div>
                <div class="form-group col-lg-6">
            ...
            <div class="tab-pane" id="grand_parent">
                ...
                <div class="form-group col-lg-6">
                    ...
                    {!! Form::text('gfather_first_name','Lila Nath',array('class'=>'form-control')) !!}
                </div>
                <div class="form-group col-lg-6">
                    {!! Form::label('gfather_last_name','Last Name') !!}
                    {!! Form::text('gfather_last_name','Dhungana',array('class'=>'form-control')) !!}
                </div>
                <div class="form-group col-lg-6">
                    {!! Form::label('gfather_full_name','Last Name') !!}
                    <font face="Nepali">{!! Form::text('gfather_full_name','Lila Nath Dhungana',array('class'=>'form-control','placeholder'=>'नेपालीमा')) !!}</font>
                </div>
                <div class="col-lg-12">
                    <h3>Citizenship Certificate Detail</h3>
                </div>
                <div class="form-group col-lg-6">
                    ...
                    {!! Form::text('gfather_citizenship_no','2233/4455',array('class'=>'form-control')) !!}
                </div>
                <div class="form-group col-lg-6">
            ...
            <div class="tab-pane" id="informer">
                ...
                <div class="form-group col-lg-12">
                    ...
                    {!! Form::text('brth_informer','Arjun Prashad Dhungana',array('class'=>'form-control')) !!}
                </div>
